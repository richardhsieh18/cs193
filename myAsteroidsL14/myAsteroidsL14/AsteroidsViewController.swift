...
class AsteroidsViewController: UIViewController
{
    ...
    private func initializeIfNeeded()
    {
        ...
        {
            asteroidField = AsteroidFieldView(frame: CGRect(center: view.bounds.mid, size: view.bounds.size * Constants.asteroidFieldManitude))
    ...
    private func burn(){
        ...
        asteroidBehavior.acceleration.magnitude = Constants.butnAcceleration
    }
    ...
    private struct Constants
    {
        ...
        static let asteroidFieldManitude: CGFloat = 10  //as a multiple of view.bounds.size
        static let normalizedDistanceOfShipFromEdge: CGFloat = 0.2
        static let butnAcceleration: CGFloat = 0.07 // points/s/s
        struct Shield
        {
        ...
        static let normalizedAsteroidFieldCenter:
        [UIInterfaceOrientation:CGPoint] = [
